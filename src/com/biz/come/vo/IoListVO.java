...
public class IoListVO {
	...
	public String toString() {
		return "IoListVO [strDate=" + strDate + ", intIO=" + intIO + ", strCName=" + strCName + ", intPrice=" + intPrice
				+ ", intQuan=" + intQuan + ", getStrDate()=" + getStrDate() + ", getIntIO()=" + getIntIO()
				+ ", getStrCName()=" + getStrCName() + ", getIntPrice()=" + getIntPrice() + ", getIntQuan()="
				+ getIntQuan() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}
